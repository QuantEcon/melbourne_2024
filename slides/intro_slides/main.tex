...
\begin{frame}
    ...
    \begin{figure}
       \centering
        \scalebox{.6}{\includegraphics{ppf.pdf}}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
       \begin{center} % l b r t
        \scalebox{.36}{\includegraphics{matlab.pdf}}
       \end{center}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
       \begin{center} % l b r t
        \scalebox{.36}{\includegraphics{numpy.pdf}}
       \end{center}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
       \begin{center}
        \scalebox{0.36}{\includegraphics{matlab_numpy_fortran.png}}
       \end{center}
    \end{figure}
